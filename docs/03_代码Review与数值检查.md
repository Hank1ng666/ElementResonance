...
- baseDamage 10→15（诊断口径：开局 DPS 12.5 < 刷怪流量 13.3 血/秒。机械层面对杂兵按命中档位生效——血量成长后 21~30 血区间 3 刀压回 2 刀、清怪吞吐 +50%；DPS +50% 对精英/Boss 等高血目标直接成立。复核勘误见 05·D4-01）
...
- 演示录屏局（2026-09-14，README 截图来源）：**6:08 胜利 / Lv18 / 401 击杀**——验收基准之后另录的一局实机演示，数值未再改动
